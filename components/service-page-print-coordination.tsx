  ...
  return (
    <div className="min-h-screen">
      ...
      <ServiceHero
        ...
        backgroundAlt="Coordination impression Luxembourg - Imprimerie professionnelle"
      >
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="mx-auto max-w-5xl">
            <FadeIn className="text-center">
              <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">Ce que nous gérons pour vous</h2>
